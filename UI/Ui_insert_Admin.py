...
# Form implementation generated from reading ui file 'c:\code\mysql\BookStore\insert_Admin.ui'
#
...
class Ui_Insert_Admin(object):
    def setupUi(self, Insert):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 10, 201, 241))
...
"}")
    ...
    def retranslateUi(self, Insert):
        ...
        self.lineEdit.setPlaceholderText(_translate("Insert", "管理员编号"))
        self.lineEdit_2.setPlaceholderText(_translate("Insert", "管理员名字"))
        self.lineEdit_3.setPlaceholderText(_translate("Insert", "设置密码"))

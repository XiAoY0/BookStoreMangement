...
# Form implementation generated from reading ui file 'c:\code\mysql\BookStore\insert.ui'
#
...
"}")
    ...
    def retranslateUi(self, Insert):
        ...
        self.lineEdit.setPlaceholderText(_translate("Insert", "图书编号"))
        self.lineEdit_2.setPlaceholderText(_translate("Insert", "图书名称"))
        self.lineEdit_3.setPlaceholderText(_translate("Insert", "图书出版社"))
        self.lineEdit_7.setPlaceholderText(_translate("Insert", "图书价格"))
        self.lineEdit_6.setPlaceholderText(_translate("Insert", "图书作者"))
        self.lineEdit_5.setPlaceholderText(_translate("Insert", "图书类别"))
        self.label.setText(_translate("Insert", "库存总数"))

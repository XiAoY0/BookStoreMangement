...
class Ui_Insert(object):
    def setupUi(self, Insert):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 201, 361))
...
"}")
    ...
    def retranslateUi(self, Insert):
        ...
        self.lineEdit.setPlaceholderText(_translate("Insert", "ISBN"))
        self.lineEdit_2.setPlaceholderText(_translate("Insert", "书名"))
        self.lineEdit_3.setPlaceholderText(_translate("Insert", "作者"))
        self.lineEdit_4.setPlaceholderText(_translate("Insert", "出版时间"))
        self.lineEdit_5.setPlaceholderText(_translate("Insert", "出版社"))
